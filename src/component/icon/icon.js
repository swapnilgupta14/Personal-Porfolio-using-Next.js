...
export const Custom = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="cursor"><g><path fill="#338b93" d="M20.9697,10.8643c0.1826-1.3604-0.4795-2.6602-1.6875-3.3105c-3.4756-1.8721-7.1885-3.2705-11.0352-4.1582L6.8936,3.083
    ...
    c3.6719,0.8467,7.2168,2.1826,10.5361,3.9707C19.0488,9.7002,19.0146,10.3945,18.9873,10.5977z"></path>
    <path fill="#338b93" d="M17 16c-.5527 0-1 .4473-1 1s.4473 1 1 1h2c.5527 0 1-.4473 1-1s-.4473-1-1-1H17zM21 19h-4c-.5527 0-1 .4473-1 1s.4473 1 1 1h4c.5527 0 1-.4473 1-1S21.5527 19 21 19z"></path></g></svg>
  );
};
