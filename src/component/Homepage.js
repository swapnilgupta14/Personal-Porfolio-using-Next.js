  ...
  const handleButtonClick = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        link.href =
          "https://drive.google.com/file/d/10Aq7BljScKLy-G8FTlHwjYk874xG7YOL/view?usp=sharing";
        link.target = "_blank";
      ...
      <div className="frontpage-container" id="home">
        ...
        <div className="container" id="otherElement">
          <div className="name">
            ...
            <p className="detail prjHome">
              A front-end developer passionate about building accessible <br />{" "}
          ...
          <div className="button-wrapper">
            <div className="for-mobile">
              <Link href="mailto:mail.swapnilgupta@gmail.com">
                <button className="download-button comic-neue-bolder prjHome">
                  Get in touch
                </button>
              </Link>
              <Link
                href="https://drive.google.com/file/d/1lkYROIEsFh7hk-zXhZ2-qXXKAhrA-2nW/view?usp=drive_link"
                passHref
              >
            ...
            {!isSmallScreen && (
              <div className="for-mobile">
                <a
                  href="https://www.linkedin.com/in/swapnilgupta-ln/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="icon" style={{ marginBottom: "-7px" }}>
                    <Linkedin width={35} height={35} />
                  </button>
                </a>
                <a
                  href="https://github.com/swapnilgupta14"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="icon">
                    <Github width={35} heght={35} />
                  </button>
                </a>
              </div>
            )}
